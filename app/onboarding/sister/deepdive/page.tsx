  ...
  useEffect(() => {
    async function load() {
      ...
      const { data } = await supabase
        ...
        .select('parent_relationship, inlaws_living_together, family_spouse_disagreement, marriage_vision_10_years, romance_view, marriage_fear, unique_contribution, health_background_disclosure')
        .eq('id', user.id)
        .single()
      if (data) {
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F3]">
      <div className="max-w-[480px] mx-auto px-5 py-8 pb-28">
        ...
        <form id="sister-deepdive-form" onSubmit={handleSubmit} className="space-y-8">
