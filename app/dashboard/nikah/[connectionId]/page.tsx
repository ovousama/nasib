...
export default async function NikahPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-[#FDF8F3]">
      <div className="px-4 pt-8 pb-4 bg-white border-b border-[#EDE8E3]">
        <Link href="/dashboard" className="text-[#9B9B9B] hover:text-[#5C5C5C] text-sm flex items-center gap-1 mb-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-medium text-[#1A1A1A]">Nikah Planning</h1>
      ...
      <div className="px-4 py-6 space-y-5 max-w-lg">
        ...
        <div className="bg-white rounded-2xl border border-[#EDE8E3] shadow-sm overflow-hidden">
          <div className="px-4 py-3 border-b border-[#FDFAF7]">
            <h2 className="text-sm font-medium text-[#1A1A1A]">Nikah Checklist</h2>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-[#EDE8E3] shadow-sm p-4">
          <h2 className="text-sm font-medium text-[#1A1A1A] mb-3">Dua for Marriage</h2>
          <div className="bg-[#FDF8F3] rounded-xl p-4 text-center mb-3">
        ...
        <button
          ...
          className="w-full border border-gray-300 text-[#5C5C5C] font-medium py-2.5 rounded-xl hover:bg-[#FDF8F3] transition-colors text-sm flex items-center justify-center gap-2"
        >
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
