    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      <div className="max-w-lg mx-auto px-4 py-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-lg font-semibold text-[#1A1A1A]">Edit Reference</h1>
        </div>

        {!reference ? (
          <div className="text-center py-10">
            <p className="text-[#6B6B6B] text-sm mb-4">No reference on file. Please complete the onboarding flow to add a reference.</p>
          ...
          <div className="bg-white rounded-2xl border border-[#EBEBEB] p-5 flex flex-col gap-3">
            ...
            <div className="border-t border-[#EBEBEB] pt-3 flex flex-col gap-2">
