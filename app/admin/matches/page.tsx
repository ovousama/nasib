  ...
  return (
    <div className="max-w-6xl">
      <div className="flex items-center justify-between mb-5">
        <div>
          <h2 className="text-xl font-bold text-[#1A1A1A]">Matches</h2>
          <p className="text-sm text-[#6B6B6B] mt-0.5">{matches.length} total</p>
        </div>
        <Link
          href="/admin/matches/new"
          className="bg-[#AF4D98] text-white text-sm font-medium px-4 py-2.5 rounded-xl hover:bg-[#9B3D85] transition-colors"
        >
          + Assign New Match
        </Link>
      </div>
