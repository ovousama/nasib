  ...
  return (
    <div style={{ background: '#F5F0FB', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #AF4D98, #D66BA0)', padding: '24px 20px 28px', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Wali badge */}
        {waliProfile && (
          <div data-testid="wali-status" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,0.2)', borderRadius: '999px', padding: '5px 12px', marginBottom: '16px', position: 'relative' }}>
