  ...
  return (
    <div style={{ background: 'linear-gradient(180deg, #F5E6F2 0%, #F4E4BA 40%, #FDF5E6 100%)', minHeight: '100vh' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #C2477A 0%, #D4689A 40%, #E896B8 70%, #EFB8CC 100%)', padding: '24px 20px 32px', position: 'relative', overflow: 'hidden' }}>
        ...
        {/* Wali badge */}
        {waliProfile && (
          <div data-testid="wali-status" style={{ display: 'inline-flex', alignItems: 'center', gap: '6px', background: 'rgba(255,255,255,0.2)', borderRadius: '999px', padding: '5px 12px', marginBottom: '18px', position: 'relative' }}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="rgba(255,255,255,0.8)" width="13" height="13">
              <path d="M10 8a3 3 0 100-6 3 3 0 000 6zM3.465 14.493a1.23 1.23 0 00.41 1.412A9.957 9.957 0 0010 18c2.31 0 4.438-.784 6.131-2.1.43-.333.604-.903.408-1.41a7.002 7.002 0 00-13.074.003z" />
            </svg>
            <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.9)' }}>Wali: {waliProfile.full_name} · Read-only access</span>
          </div>
        )}
